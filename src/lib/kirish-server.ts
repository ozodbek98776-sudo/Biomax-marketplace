...
//   · /api/kirish — kirish kodi butunlay o'chirilganda (KIRISH_KODI=ochirilgan)
//   · /api/kirish/kod — kod yoqilgan, lekin ERP bilan aloqa BUZUQ bo'lgani
//     uchun kodni yetkazib bo'lmagan paytda zaxira yo'l sifatida
//
